<template>
  <div class="flex justify-center flex-col">
    <div
      class="w-full h-52 bg-indigo-500 mb-8 flex items-center justify-center relative shadow-2xl"
    >
      <button @click="logout" class="absolute right-2 top-2 hover:text-red-800">
    ...
    <div id="admin-page-container" class="mx-4 flex flex-col">
      <DataTable
        :tableData="users"
        :fields="['ID', 'Username', 'Password', 'Email', 'User Role']"
      />
      <DataTable class="mt-4" :fields="['Club Name', 'Members']" />
    </div>
  </div>
</template>
      ...
      users: [
        ...
        },
        {
          ...
          address: {
            ...
            user_id: 5,
            line1:
              "91792 Kertzmann Prairie Apt. 376\nLake Nakiaville, DC 98189",
            line2: "Jamaica",
            zipcode: "10101-1450",
            mobile: "07507519787",
            fax: "+24(9)5120507985",
